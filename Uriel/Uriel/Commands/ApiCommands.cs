...
/// <summary>
/// Structured chat output for BloodCraftHub (BCH) — the [URIEL:*] wire API (BCH handoff §6,
/// mirroring Beelzebub's [BEELZ:*] pattern).
///
...
internal static class ApiCommands
{
    ...
    [Command("version", description: "BCH: object-spawn API version, capabilities + catalog totals.")]
    ...
    [Command("catalog", description: "BCH: the total prefab list available in-game (paged). Usage: .uriel api catalog [page]")]
